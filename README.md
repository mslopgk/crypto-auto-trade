...
3. **워크포워드**: 22개 셀에 롤링 12개월 IS / 3개월 OOS 재최적화(플래토-센터 선택). WFE ≥ 0.5 & OOS 샤프 기준 → 10개 셀 생존
4. **앙상블**: 역변동성 가중 + 상관 페널티(>0.7), 셀당 35% 상한
5. **홀드아웃**: 최근 180일(한 번도 안 본 데이터) 단 1회 평가

## 검증 결과 (2026-07-08)

**워크포워드 OOS (5년 스티치, 시장 전 구간):**

| 전략 셀 | OOS 샤프 | OOS CAGR | MDD | WFE |
|---|---|---|---|---|
| binance BTC 1d tsmom | 1.52 | 29.4% | 18.8% | 0.87 |
| upbit BTC 1d tsmom | 1.52 | 33.2% | 24.0% | 0.65 |
| upbit ETH 4h ema_cross | 1.78 | 104.3% | 38.0% | 0.61 |
| upbit BTC 4h ema_cross | 1.76 | 69.8% | 44.2% | 0.59 |
| binance ADA 1d tsmom | 1.44 | 33.2% | 25.3% | 1.01 |
| (외 5개 셀, 전체 목록 config/ensemble.json) | | | | |

**홀드아웃 (2026-01-08 → 2026-07-07, 급락장):**
